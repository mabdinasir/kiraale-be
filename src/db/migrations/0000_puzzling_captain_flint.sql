CREATE TYPE "public"."agencyRole" AS ENUM('ADMIN', 'AGENT');--> statement-breakpoint
...
ALTER TABLE "property" ADD CONSTRAINT "property_agencyId_agency_id_fk" FOREIGN KEY ("agencyId") REFERENCES "public"."agency"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
